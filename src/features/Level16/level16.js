    ...
    const addNumber = (number) => {
        ...
        if( answer != null && answer.length > 5) {
            ...
            if(question == `${answer}${number}`) {
                props.navigation.navigate('Level17', { 
    ...
    return (
        <View style={styles.mainView}>
            ...
            <View style={styles.scoreAndHeading}>
                <View>
                    <Text style={styles.heading1}>Level 16</Text>
                    <Text style={styles.difficulty1}>Difficulty Level: Medium</Text>
                </View>
